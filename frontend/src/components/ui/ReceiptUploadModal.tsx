      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          ...
          <div
            ...
            className="border-2 border-dashed border-slate-200 rounded-xl flex flex-col items-center justify-center py-7 gap-2 cursor-pointer hover:[border-color:var(--pf-primary)] hover:[background:var(--pf-primary-soft)] transition-colors"
          >
            {preview ? (
              ...
              <>
                ...
                <p className="text-xs text-slate-500">Kéo thả hoặc <span className="[color:var(--pf-primary)] font-semibold">chọn file</span></p>
