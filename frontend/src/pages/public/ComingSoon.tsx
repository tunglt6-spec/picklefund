    ...
    <PublicPage title="Đang hoàn thiện">
      <div className={`${PUBLIC_CONTAINER} py-24 text-center`}>
        ...
        <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
          <a href="/" className="rounded-full border px-5 py-2.5 text-sm font-semibold [border-color:var(--pf-border)] hover:[background:var(--pf-surface-muted)]">Trang chủ</a>
          <a href="/product/aido" className="rounded-full border px-5 py-2.5 text-sm font-semibold [border-color:var(--pf-border)] hover:[background:var(--pf-surface-muted)]">AI Digital Office</a>
          <a href="/pricing" className="rounded-full px-5 py-2.5 text-sm font-semibold text-white" style={{ background: 'var(--pf-primary)' }}>Bảng giá</a>
        </div>
      </div>
    </PublicPage>
  )
