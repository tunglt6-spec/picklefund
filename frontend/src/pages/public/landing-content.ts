  ...
  groups: [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: Newspaper, title: 'Tin tức PickleFund', desc: 'Cập nhật sản phẩm, hoạt động và các phiên bản mới.', href: '/resources/news' },
    ...
    },
    {
      ...
      items: [
        ...
        { icon: FileText, title: 'Release Notes', href: '/resources/release-notes' },
      ],
    },
  ],
}
  ...
  groups: [
    ...
    },
    {
      items: [
        ...
        { icon: Briefcase, title: 'Đối tác', desc: 'Các tổ chức, cộng đồng và đơn vị hợp tác.', href: '/partners' },
...
export const FOOTER_GROUPS: { title: string; items: MenuItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Tin tức', href: '/resources/news' },
      { title: 'Release Notes', href: '/resources/release-notes' },
