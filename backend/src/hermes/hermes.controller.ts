...
export class HermesController {
  ...
  async markAllAsRead(@CurrentUser() user: any) {
    return ok(await this.svc.markAllAsRead(user.userId), 'Đã đánh dấu tất cả đã đọc')
  }
  ...
  async updatePreferences(
    ...
    return ok(await this.svc.updatePreferences(user.userId, body), 'Đã cập nhật cài đặt thông báo')
  }
}
